...
function(Zoom, Home, Locate, Compass, BasemapToggle, NavToggle, Search, Legend, LayerList, Track, Print, Component, FeatureLayer, PopupTemplate, WebMap,
  ...
  var PanelSettings = declare(null, {
    ...
    setWidgetPosition: function(view, name, position, index, id,layer) {
      var component,
      ...
      if (position === "none") {
          ...
          if (exists) {
            ...
            component = _this.createComponent(view, name, id,layer);
            if (!id) {
              view.ui.add([{ 
                component: component, 
                position: position, 
    ...
    createComponent: function(view, name, id,layer) {
        var component,
        widget = _this.createWidget(view, name, id,layer);
    ...
    createWidget: function(view, name, id,layer) {
      var widget,
        viewModel = {
          view: view
        }
      switch (name) {
        ...
        case "layerlist":
          ...
          widget.on("trigger-action", function(event) {
        ...
        case "print":
          widget = new Print({
            viewModel: viewModel,
            container: id,
            printServiceUrl:MapConfig.url.printSeverUrl
          });
          break;
